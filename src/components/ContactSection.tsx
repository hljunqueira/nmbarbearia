...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-contact-pattern bg-cover bg-center bg-fixed">
      <div className="bg-black bg-opacity-55 py-20">
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden">
              ...
              >
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"
                >
